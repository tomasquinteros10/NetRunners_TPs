...
La Figura 3.4 muestra el efecto de eliminar las componentes de alta
frecuencia de un pulso cuadrado, conservando únicamente las componentes
de baja frecuencia.

En la Figura 3.4 se observa una señal compuesta por una frecuencia
fundamental $f$ y su tercer armónico $3f$. La frecuencia $3f$ es un
múltiplo entero de la frecuencia fundamental $f$.

La componente fundamental puede expresarse como:

\[
s_1(t)=\sen(2\pi f t)
\]

mientras que el tercer armónico es:

\[
s_3(t)=\frac{1}{3}\sen(2\pi(3f)t)
\]
...
\left[
\sen(2\pi f t)
+\frac{1}{3}\sen(2\pi(3f)t)
\right]
\]

Para representar los gráficos, se utiliza el período de la frecuencia
fundamental como unidad de tiempo, es decir, $x=t/T$, donde
$T=1/f$.
...
\begin{axis}[
  ...
  ytick={-1,0,1},
  grid=both,
  title={Componente fundamental $f$}
]
\addplot[
  domain=0:2,
  samples=300
...
\begin{axis}[
  ...
  ytick={-1,0,1},
  grid=both,
  title={Suma de las componentes $f$ y $3f$}
]
\addplot[
  domain=0:2,
  samples=600
...
\caption{Componentes en frecuencia y suma de la señal, siguiendo
la Figura 3.4 de Stallings.}
\end{figure}

Si se realiza el proceso contrario al mostrado en la Figura 3.4, es
decir, se eliminan las componentes de baja frecuencia y se conservan
únicamente las componentes de alta frecuencia, la señal resultante queda
dominada por oscilaciones rápidas.

En el ejemplo de la Figura 3.4, si se elimina la frecuencia fundamental
$f$ y se conserva únicamente el tercer armónico $3f$, queda:

\[
s(t)=\frac{4}{3\pi}\sen(2\pi(3f)t)
\]

La señal resultante presenta tres veces la frecuencia de la componente
fundamental y, por lo tanto, oscila tres veces más rápido.

\begin{figure}[H]
\centering

% Solo tercer armónico después de eliminar la fundamental
\begin{tikzpicture}
\begin{axis}[
  width=0.85\textwidth,
  height=5cm,
...
\caption{Señal resultante al conservar únicamente el tercer armónico.}
\end{figure}

Por lo tanto, al eliminar las componentes de baja frecuencia y conservar
las de alta frecuencia, se obtiene una señal con oscilaciones más rápidas
y se pierde la forma general del pulso cuadrado.
